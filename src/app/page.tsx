...
export default async function HomePage() {
  const [videos, articles, tweets] = await Promise.all([
    getYouTubeVideos(8),
    getArticles(6),
    getTweets(5),
  ]);
    ...
    <>
      ...
      <section className="relative bg-[#0A0A0A] overflow-hidden min-h-[85vh] md:min-h-[75vh] flex items-center">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-8 select-none pointer-events-none hidden lg:block opacity-10">
          <img src="/logo.png" alt="" className="w-[480px] h-auto" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="max-w-3xl">
            ...
            <p className="font-condensed text-[#8A8A8A] text-xl md:text-2xl leading-relaxed mb-8 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              ...
              <a href="#newsletter" className="flex items-center gap-2 bg-transparent border border-[#2E2E2E] hover:border-[#F5A623] text-[#C4C4C4] hover:text-white font-condensed font-bold tracking-widest uppercase px-7 py-4 rounded-lg transition-all text-sm">
                Newsletter
              </a>
            </div>
            <div className="flex items-center gap-4 flex-wrap">
              ...
              {[
                ...
                { name: 'TikTok', href: 'https://tiktok.com/@fieldof68', color: 'hover:text-[#69C9D0]' },
              ].map(({ name, href, color }) => (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex items-center justify-between mb-6 md:mb-8">
          ...
          <a href="https://www.youtube.com/@TheFieldOf68" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 bg-[#FF0000] hover:bg-[#CC0000] text-white font-condensed font-bold text-xs tracking-widest uppercase px-4 py-2 rounded transition-colors">
            Watch on YouTube
          </a>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 bg-[#111111] rounded-lg p-4 flex flex-col gap-2">
            ...
            <div className="mt-auto pt-4 border-t border-[#1A1A1A]">
              <Link href="/videos" className="flex items-center justify-center gap-2 w-full bg-[#1A1A1A] hover:bg-[#242424] text-[#C4C4C4] hover:text-white font-condensed font-bold text-xs tracking-widest uppercase py-3 rounded transition-colors">
                View All Videos →
              </Link>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex items-center justify-between mb-6 md:mb-8">
          ...
          <Link href="/articles" className="text-[#F5A623] font-condensed font-bold text-xs tracking-widest uppercase hover:text-[#FFBE4D] transition-colors">
            All Articles →
          </Link>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 bg-[#111111] rounded-lg p-4 flex flex-col gap-2">
            ...
            <div className="mt-auto pt-4 border-t border-[#1A1A1A]">
              <Link href="/articles" className="flex items-center justify-center gap-2 w-full bg-[#1A1A1A] hover:bg-[#242424] text-[#C4C4C4] hover:text-white font-condensed font-bold text-xs tracking-widest uppercase py-3 rounded transition-colors">
                View All Articles →
              </Link>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex items-center justify-between mb-6 md:mb-8">
          ...
          <a href="https://twitter.com/TheFieldOf68" target="_blank" rel="noopener noreferrer"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex items-center justify-between mb-6 md:mb-8">
          ...
          <Link href="/shows" className="text-[#F5A623] font-condensed font-bold text-xs tracking-widest uppercase hover:text-[#FFBE4D] transition-colors">
            All Shows →
          </Link>
        </div>
        <div className="relative bg-[#111111] rounded-xl overflow-hidden border border-[#1A1A1A] group mb-6">
          <div className="flex flex-col md:flex-row">
            <div className="relative md:w-2/5 h-48 md:h-auto">
              <Image src={showsData[0].thumbnail} alt={showsData[0].name} fill
            ...
            <div className="p-6 md:p-8 flex-1 flex flex-col justify-center">
              ...
              <div className="flex gap-3">
                <a href={showsData[0].youtubePlaylistUrl} target="_blank" rel="noopener noreferrer"
                ...
                <a href={showsData[0].podcastUrl} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-[#1A1A1A] hover:bg-[#242424] text-[#C4C4C4] hover:text-white font-condensed font-bold text-xs tracking-widest uppercase px-5 py-3 rounded transition-colors">
                  Listen on Spotify
                </a>
              </div>
            </div>
