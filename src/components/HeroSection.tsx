        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full">
          <div className="max-w-xl">
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              <Link href="/videos"
                className="flex items-center gap-2 font-display text-sm tracking-widest uppercase px-7 py-4 rounded-lg"
                style={{ background: '#F5A623', color: '#000' }}>
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                WATCH NOW
              </Link>
              <Link href="/shows"
                className="font-condensed font-bold tracking-widest uppercase text-sm px-6 py-4 rounded-lg border"
